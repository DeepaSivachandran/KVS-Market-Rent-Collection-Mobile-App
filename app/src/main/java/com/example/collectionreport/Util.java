...
public class Util
{
    ...
    */
	...
	public static String nameLeftValueRightJustify(String param1, String param2,String param3,
		...
		return rightJustify(param1,12)+rightJustify(param2,8)+rightJustify(param3,11);
	}
	...
	public static String nameLeftValueRightJustifysalesbill(String param1, String param2,String param3,
		...
		return leftJustify(param1,13)+leftJustify(param2,10)+rightJustify(param3,8);
	}
    ...
    public static String nameLeftValueRightJustify(String param1, String param2,String param3,String param4,
        ...
        return rightJustify(param1,7)+ rightJustify(param2,1) +rightJustify(param3,1)+rightJustify(param4,10);
    }
	...
	public static String nameLeftValueRightJustifysalesitem(String param1, String param2,String param3,String param4,
		...
		return rightJustify(param1,5)+ "   "+ leftJustify(param2,4) +rightJustify(param3,9)
				+rightJustify(param4,10);
	}

	public static String nameLeftValueRightJustifygsttax(String param1, String param2,String param3,String param4,
															int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		/*return rightJustify(param1,5)+ " "+ leftJustify(param2,10) +
				rightJustify(param3,6) +rightJustify(param4,7);*/
		return rightJustify(param1,5)+ "   "+ leftJustify(param2,4) +rightJustify(param3,9)
				+rightJustify(param4,10);
	}

	public static String nameLeftValueRightJustifysalesfreeitem(String param1, String param2,String param3,String param4,
															int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,5)+ " "+ leftJustify(param2,6) +rightJustify(param3,6) +
				rightJustify(param4,10);
	}

	public static String nameLeftValueRightJustifysalesitemless(String param1, String param2,String param3,String param4,
															int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,5)+ " "+ leftJustify(param2,7) +rightJustify(param3,6)
				+rightJustify(param4,10);
	}



	public static String nameLeftValueRightJustifysalesitemexc(String param1, String param2,String param3,String param4,
																int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,5)+ " "+ leftJustify(param2,4) +rightJustify(param3,6)
				+rightJustify(param4,12);
	}
	...
	public static String palmtecnameLeftValueRightJustifycashtaxvalues(String param1, String param2,String param3, String param4,
																int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,2)+ " "+ rightJustify(param2,2) + " "+ rightJustify(param3,8)
				+ " "+ rightJustify(param4,6) ;
	}


	public static String palmtecnameLeftValueRightJustifycashtaxvaluesbilldisc(String param1, String param2,String param3, String param4,
																	   int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
	...
	public static String vertexNameLeftValueRightJustifysalesitem(String param1, String param2,String param3,String param4,
															int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,8)+ "   "+ leftJustify(param2,6) +rightJustify(param3,14)
				+rightJustify(param4,10);
	}

	public static String vertexNameLeftValueRightJustifysalesitemless(String param1, String param2,String param3,String param4,
																int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,10)+ " "+ leftJustify(param2,14) +rightJustify(param3,12)
				+rightJustify(param4,15);
	}

	public static String vertexNameLeftValueRightJustifygsttax(String param1, String param2,String param3,String param4,
														 int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		/*return rightJustify(param1,5)+ " "+ leftJustify(param2,10) +
				rightJustify(param3,6) +rightJustify(param4,7);*/
		return rightJustify(param1,8)+ "   "+ leftJustify(param2,6) +rightJustify(param3,10)
				+rightJustify(param4,10);
	}

	public static String vertexNameLeftValueRightJustify(String param1, String param2,String param3,String param4,
												   int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,16)+ rightJustify(param2,2) +rightJustify(param3,2)+rightJustify(param4,16);
	}
	public static String vertexnameLeftValueRightJustify5(String param1, String param2,String param3,String param4,
													String param5,String param6,
													int cpl) {
		if(param1 == null)
			param1 = "";
		...
		return rightJustify(param1,8)+ rightJustify(param2,8)
				+rightJustify(param3,8) +rightJustify(param4,8)+rightJustify(param5,8)
				+rightJustify(param6,12);
	}
	public static String vertexnameLeftValueRightJustifysalesbill(String param1, String param2,String param3,
															int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return leftJustify(param1,17)+leftJustify(param2,8)+rightJustify(param3,10);
	}
	public static String vertexNameLeftValueRightJustifyTotal(String param1, String param2,String param3,String param4,
														 int cpl) {
		if(param1 == null)
			param1 = "";
		if(param2 == null)
		...
		return rightJustify(param1,9)+ rightJustify(param2,2) +rightJustify(param3,1)+rightJustify(param4,17);
	}
}
