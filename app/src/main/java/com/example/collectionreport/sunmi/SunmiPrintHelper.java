...
import com.example.collectionreport.R;
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine) {
        ...
        try {
            try {
                ...
                if (isBold) {
                    sunmiPrinterService.sendRAWData(com.softland.mobilepos.sunmi.ESCUtil.boldOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.softland.mobilepos.sunmi.ESCUtil.boldOff(), null);
                }
            }
            try {
                ...
                if (isUnderLine) {
                    sunmiPrinterService.sendRAWData(com.softland.mobilepos.sunmi.ESCUtil.underlineWithOneDotWidthOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.softland.mobilepos.sunmi.ESCUtil.underlineOff(), null);
                }
            }
